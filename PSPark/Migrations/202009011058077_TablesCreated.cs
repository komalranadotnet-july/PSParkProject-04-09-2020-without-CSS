namespace PSPark.Migrations
{
    ...
    public partial class TablesCreated : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AddServiceId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AddServices", t => t.AddServiceId, cascadeDelete: true)
                .Index(t => t.AddServiceId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ServiceDetails", "AddServiceId", "dbo.AddServices");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.ServiceDetails", new[] { "AddServiceId" });
